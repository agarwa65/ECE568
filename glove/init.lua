-- GLOVE
-- This requires file 'Handimate.htm' to exist on the ESP8266 module. Upload the file if it doesn't exist
...
cfg={}
cfg.ssid="Handimate"-- .. (string.sub(wifi.ap.getmac(), 15,17))
cfg.pwd="Handimate"
wifi.ap.config(cfg)
a={}
if srv then
...
srv:listen(80,function(conn) 
              conn:on("receive", function(conn,payload)
                  ...
                  if string.sub(payload,1,3)=='ESL' then
                      print("ESPSLAVE message received")
                      conn:send("ESE:" .. adc.read(0) .. "\n" .. (1-gpio.read(pin_but)) )
                      conn=nil
